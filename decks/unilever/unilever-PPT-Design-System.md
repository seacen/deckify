...
- UnileverDesire typeface, no serif/display fonts — Unilever's proprietary humanist sans, with Century Gothic / system-ui as fallback if not licensed for the deck context
...
- Title states the insight, not the chart type. Good: "Unilever 在三个维度全面超越对手". Bad: "Bar Chart Comparison".
